...
# Make does not offer a recursive wildcard function, and Windows needs one, so here it is:
    ...
    ifeq ($(UNAME_S),Linux)
		...
		LINKER_FLAGS :=-Wl,--no-undefined,--no-allow-shlib-undefined,-rpath='$$ORIGIN' -shared -lxcb -lX11 -lX11-xcb -lxkbcommon -lm -L/usr/X11R6/lib -L./$(BUILD_DIR) $(ADDL_LINK_FLAGS) 		# .c files
