...
KAPI b8 debug_line3d_create(vec3 point_0, vec3 point_1, ktransform parent_xform, debug_line3d* out_line);
KAPI void debug_line3d_destroy(debug_line3d* line);

KAPI void debug_line3d_parent_set(debug_line3d* line, ktransform parent_xform);
