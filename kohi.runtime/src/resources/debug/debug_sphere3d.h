...
KAPI b8 debug_sphere3d_create(f32 radius, vec4 colour, ktransform parent_xform, debug_sphere3d* out_sphere);
KAPI void debug_sphere3d_destroy(debug_sphere3d* sphere);

KAPI void debug_sphere3d_parent_set(debug_sphere3d* sphere, ktransform parent_xform);
