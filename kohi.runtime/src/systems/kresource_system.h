...
typedef struct kresource_handler {
    ...
    b8 (*request)(struct kresource_handler* self, kresource* resource, kresource_request_info info);
...
KAPI b8 kresource_system_request(struct kresource_system_state* state, kname name, kresource_type type, kresource_request_info info, kresource* out_resource);
