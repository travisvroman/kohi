...
const char* kasset_material_texture_map_channel_to_string(kasset_material_texture_map_channel channel) {
    switch (channel) {
    default:
...
kasset_material_texture_map_channel string_to_kasset_material_texture_map_channel(const char* str) {
...
const char* kasset_material_type_to_string(kasset_material_type type) {
    switch (type) {
...
kasset_material_type string_to_kasset_material_type(const char* str) {
...
const char* kasset_material_model_to_string(kasset_material_model model) {
    switch (model) {
...
kasset_material_model string_to_kasset_material_model(const char* str) {
