...
b8 plugin_create(renderer_plugin* out_plugin) {
    ...
    out_plugin->frame_begin = vulkan_renderer_backend_begin_frame;
    out_plugin->frame_end = vulkan_renderer_backend_end_frame;
    ...
    out_plugin->geometry_draw = vulkan_renderer_draw_geometry;
    ...
    out_plugin->geometry_create = vulkan_renderer_create_geometry;
    out_plugin->geometry_destroy = vulkan_renderer_destroy_geometry;

    out_plugin->shader_create = vulkan_renderer_shader_create;
    out_plugin->shader_destroy = vulkan_renderer_shader_destroy;
    out_plugin->shader_uniform_set = vulkan_renderer_set_uniform;
    ...
    out_plugin->shader_instance_resources_acquire = vulkan_renderer_shader_acquire_instance_resources;
    out_plugin->shader_instance_resources_release = vulkan_renderer_shader_release_instance_resources;

    out_plugin->texture_map_resources_acquire = vulkan_renderer_texture_map_acquire_resources;
    out_plugin->texture_map_resources_release = vulkan_renderer_texture_map_release_resources;
    ...
    out_plugin->flag_enabled_get = vulkan_renderer_flag_enabled;
    out_plugin->flag_enabled_set = vulkan_renderer_flag_set_enabled;
